<template>
      ...
      <div class="relative p-10  border border-gray-600 rounded-lg w-full max-w-md z-10">
        ...
        <Form @submit="loginSystem" v-slot="{ errors }">
          <div class="relative mb-4">
            <Icon name="material-symbols:alternate-email" size="30" class="absolute left-2 top-1 text-gray-400" />
            <Field
              name="email"
              as="input"
              type="email"
          ...
          <div class="relative mb-4">
            <Icon name="material-symbols:lock-outline" size="30" class="absolute left-2 top-1 text-gray-400" />
            <Field
              name="password"
              as="input"
              type="password"
  ...
  setup(props, { emit }) {
    ...
    const loginSystem = (values: Record<string, any>) => {
      ...
      emit("close"); // Usa emit para cerrar el modal
    };

    return { password, loginSystem };
  },
});
